...
epic_jansep19_include <- epic_fy19_include[epic_fy19_include$DischMo <= 9, ]
...
tsi_jansep19_subset <- tsi_jansep19_include[tsi_jansep19_include$Site == "MSBI", c("Encounter.No", "Msmrn", "ServiceLine", "Unit.Desc.Msx", 
