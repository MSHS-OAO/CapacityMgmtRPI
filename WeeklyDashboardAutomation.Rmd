...
```{r MSH Data, echo = FALSE, results = 'asis'}
stacked_bar("MSH")
kable(MSHWeeklyTotalPercent, caption = "MSH Weekend Discharge as Percent of Total Discharges") %>%
  kable_styling(position = "center")
```

## MSQ Weekend Discharge Dashboard
```{r MSQ Data, echo = FALSE}
stacked_bar("MSQ")
```

## MSBI Weekend Discharge Dashboard
```{r MSBI Data, echo = FALSE}
stacked_bar("MSBI")
```

## MSB Weekend Discharge Dashboard
```{r MSB Data, echo = FALSE}
stacked_bar("MSB")
```

## MSW Weekend Discharge Dashboard
```{r MSW Data, echo = FALSE}
stacked_bar("MSW")
```

## MSSL Weekend Discharge Dashboard
```{r MSSL Data, echo = FALSE, fig.align="center", fig.height=4, fig.width=4.8}
stacked_bar("MSSL")
```
