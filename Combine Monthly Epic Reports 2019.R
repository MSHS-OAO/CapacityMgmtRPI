...
epic_raw_jansep19 <- rbind(epic_raw_jan19, epic_raw_feb19, epic_raw_mar19, epic_raw_apr19, epic_raw_may19, epic_raw_jun19, epic_raw_jul19, epic_raw_aug19, epic_raw_sep19)
epic_raw_octdec19 <- rbind(epic_raw_oct19, epic_raw_nov19, epic_raw_dec19)

# write_xlsx(epic_raw_2019, path = paste0("Epic Discharge Timings Report FY2019 ", Sys.Date(), ".xlsx"))
write_xlsx(epic_raw_jansep19, path = paste0("Epic Discharge Timings Report JanSep19 ", Sys.Date(), ".xlsx"))
write_xlsx(epic_raw_octdec19, path = paste0("Epic Discharge Timings Report OctDec19 ", Sys.Date(), ".xlsx"))
